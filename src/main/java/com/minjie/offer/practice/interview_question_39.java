 ...
 * @Description: TODO 面试题39：直方图的最大矩形面积
 * @Version: 1.0
 */

public class interview_question_39 {
    public static void main(String[] args) {

        interview_question_39 testObject = new interview_question_39();
        ...
        System.out.println(testObject.largestRectangleArea(testInt));
